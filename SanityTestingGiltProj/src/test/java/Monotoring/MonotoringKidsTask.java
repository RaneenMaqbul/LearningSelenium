...
public class MonotoringKidsTask {
	WebDriver driver;
	@Test(priority=1)
	public void login_With_Valid_Email_And_Password() throws InterruptedException {
		...
		wait112.until(ExpectedConditions.elementToBeClickable(By.xpath("//*[@id=\"ng-app\"]/body/div[4]/div/div[1]/div/div/div/div[2]/div[1]/div/div[1]/h2[3]/a")));
		Actions action222 = new Actions(driver);
		action222.click(driver.findElement(By.xpath("//*[@id=\"ng-app\"]/body/div[4]/div/div[1]/div/div/div/div[2]/div[1]/div/div[1]/h2[3]/a"))).build().perform();
